...
#define APP_TIMER_PERIOD 			 9000
#define APP_OAD_IN_PROGRESS_PERIOD	 30000   //5minute«Â¡„
/*
 * ENUMERATIONS
 ****************************************************************************************
 */
...
enum appm_msg
{
	...
	APP_OAD_IN_PROGRESS_TIMER,
};
/*
typedef struct 
{
	uint8_t  ms_uart_data[64];
	
    uint16_t ms_uart_data_len;
	
	uint16_t ms_uart_state;
}ms_uart_struct;
*/
/*
