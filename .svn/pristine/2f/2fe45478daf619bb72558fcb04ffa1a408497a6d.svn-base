...
#define BYTE_MSB(_val)              ( (((_val) >> 4) & 0x0f) )
/*! \brief Extract the LSB of a 16-bit integer. */
#define BYTE_LSB(_val)              ( ((_val) & 0x0f) )

#define MS_LOCK_SERVICE_DATA_LEN	  32

#if ENABLE_UNUSED_SECTION_WRITE
#define FLASH_APP_OTA_PROGRESS_FLAG	 		 0x00000000
#define SEC_UNUSED_ALLOC_FADDR 				 0x00043000
#endif
/*
 * TYPE DEFINITIONS
 ****************************************************************************************
