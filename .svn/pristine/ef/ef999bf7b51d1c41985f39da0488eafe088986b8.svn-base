...
void init_analog_xvr_reg(void)
{
	...
	if((system_mode & RW_DUT_MODE) == RW_DUT_MODE)
	{
		...
		mHWreg_Assign_XVR_Regsiter(0A, 0x1C07ED35);
		XVR_ANALOG_REG_BAK[0x0A] = 0x1C07ED35;
	...
	else
	{
		...
		mHWreg_Assign_XVR_Regsiter(0B, 0xD1FD260C);//0xd1Fd240C); //0xD3DD240C  71FD240C
		XVR_ANALOG_REG_BAK[0x0B] = 0xD1FD260C;
